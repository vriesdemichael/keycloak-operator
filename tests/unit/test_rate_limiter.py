...
class TestRateLimiterMetrics:
    ...
    @pytest.mark.asyncio
    @patch('keycloak_operator.observability.metrics.RATE_LIMIT_WAIT_SECONDS', MagicMock())
    @patch('keycloak_operator.observability.metrics.RATE_LIMIT_ACQUIRED_TOTAL', MagicMock())
    ...
    @pytest.mark.asyncio
    @patch('keycloak_operator.observability.metrics.RATE_LIMIT_TIMEOUTS_TOTAL', MagicMock())
