# Generated from Keycloak OpenAPI Spec keycloak-api-26.4.1.yaml
# DO NOT EDIT MANUALLY

# generated by datamodel-codegen:
#   filename:  keycloak-api-26.4.1.yaml
...
class WorkflowConditionRepresentation(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    uses: str | None = None
...
class WorkflowRepresentation(BaseModel):
    ...
    enabled: bool | None = None
    on: Any | None = None
    reset_on: Annotated[Any | None, Field(alias="reset-on")] = None
    recurring: bool | None = None
    if_: Annotated[list[WorkflowConditionRepresentation] | None, Field(alias="if")] = (
        None
    )
    ...
    on_values: Annotated[list[str] | None, Field(alias="onValues")] = None
    on_events_reset: Annotated[list[str] | None, Field(alias="onEventsReset")] = None


class WorkflowSetRepresentation(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    workflows: list[WorkflowRepresentation] | None = None
