# Generated from Keycloak OpenAPI Spec keycloak-api-24.0.5.yaml
# DO NOT EDIT MANUALLY

# generated by datamodel-codegen:
#   filename:  keycloak-api-24.0.5.yaml
...
class ClientPolicyConditionRepresentation(BaseModel):
    ...
    configuration: list[Any] | None = None
...
class IDToken(BaseModel):
    ...
    auth_time_1: Annotated[int | None, Field(alias="authTime", deprecated=True)] = None
    sid: str | None = None
...
class PathSegment(BaseModel):
    ...
    path: str | None = None
    matrix_parameters: Annotated[
        dict[str, list[str]] | None, Field(alias="matrixParameters")
    ] = None
